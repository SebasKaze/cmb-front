...
function ContribucionSection({ id, onRemove, onChange }) {
    return (
        <div className="grid grid-cols-3 gap-4 bg-gray-200 p-4 rounded mb-4">
            <div>
                ...
                name="contribucion"
                onChange={(e) => onChange(id, "contribucion", e.target.value)}
                >
            ...
            <div>
                ...
                name="claveTipoTasa"
                onChange={(e) => onChange(id, "claveTipoTasa", e.target.value)}
                >
                    <option value="" disabled selected>
                        Seleccione una opción
                    </option>
            ...
            <div>
                ...
                name="tasa"
                onChange={(e) => onChange(id, "tasa", e.target.value)}
                />
            </div>
