        ...
        <div className="p-6">
            ...
            <div className="grid grid-cols-3 gap-4">
                <div className="flex flex-col items-center text-center">
                    ...
                    <input disabled className="w-full border border-gray-300 rounded p-2" type="text"
                    name="id_fiscal"
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <input disabled className="w-full border border-gray-300 rounded p-2" type="date"
                    name="fecha_factu"
