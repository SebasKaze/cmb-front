...
function Home({ userData }) {
  ...
  return (
    <div className="flex w-full h-screen">
      ...
      <div
        className={`${
          open ? "w-56" : "w-24" // Reducir el tamaño a "w-56" cuando abierto, en lugar de "w-72"
        } duration-300 h-full p-5 pt-8 bg-blue-900 fixed top-0 left-0 z-10 shadow-lg mt-20 overflow-y-auto`} // Ajustes para evitar el desbordamiento
      >
        <img
      ...
      <div
        className={`flex flex-col flex-1 h-screen ${
          open ? "ml-56" : "ml-24"
        } overflow-y-auto`} // Ajuste el margen izquierdo para que coincida con el nuevo tamaño del menú
      >
